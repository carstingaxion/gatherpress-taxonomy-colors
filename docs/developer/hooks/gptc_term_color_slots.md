...
- [includes/classes/class-term-color-tokens.php:200](https://github.com/carstingaxion/gatherpress-taxonomy-colors/blob/main/includes/classes/class-term-color-tokens.php#L200)
```php
